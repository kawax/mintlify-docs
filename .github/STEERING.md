...
- [ ] GitHub Copilot SDK for Laravel。https://github.com/invokable/laravel-copilot-sdk
 ...
 - 日本語版は元のSDKリポジトリのdocs/jp/を参照する。日→英→日と翻訳を挟むと情報が抜けすぎる。docs/jp/はGitHubまで見る人用なのでドキュメントサイト用に調整はしていい。`SessionConfig`のタイトルまで「セッション設定」と翻訳しているけどこの辺りは英語のままの方が分かりやすいのでそのままにする。
...
- [ ] Laravel Boost Custom Agent for GitHub Copilot CLI https://github.com/invokable/laravel-boost-copilot-cli
 ...
 - GitHub Copilotが動く環境は色々あるのにあまり考慮してない。
