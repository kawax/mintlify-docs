...
[ファサード](/jp/intermediate/facades)とヘルパー関数は、サービスコンテナからContractを型ヒントで解決する必要なく、Laravelのサービスを簡単に利用する方法を提供しています。ほとんどの場合、各ファサードには対応するContractがあります。
...
<Steps>
  ...
  <Step title="サービスプロバイダでバインドする">
    [サービスプロバイダ](/jp/intermediate/service-providers)でContractと実装をバインドします。
...
<Card title="ファサード" icon="layer-group" href="/jp/intermediate/facades">
