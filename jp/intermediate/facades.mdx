...
ファサードは、アプリケーションの[サービスコンテナ](/jp/intermediate/service-container)で利用可能なクラスへの「静的」なインターフェースを提供します。Laravelにはほぼすべての機能にアクセスできる多くのファサードが同梱されています。
...
<Card title="Contracts（契約）" icon="file-contract" href="/jp/intermediate/contracts">
