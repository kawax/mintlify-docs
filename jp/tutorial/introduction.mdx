...
シニア開発者には、[依存性注入](/jp/intermediate/service-container)・[ユニットテスト](/jp/tutorial/testing)・[キュー](/jp/intermediate/queues)・[リアルタイムイベント](/jp/intermediate/broadcasting)などの堅牢なツールを提供します。
...
<Card title="インストール" icon="download" href="/jp/tutorial/installation">
