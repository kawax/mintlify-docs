...
[ビュー](/jp/tutorial/views)と、コンパイル前のCSSやJavaScriptなどの生アセットを格納します。
...
<AccordionGroup>
  ...
  <Accordion title="Models/ ディレクトリ">
    [Eloquentモデル](/jp/tutorial/eloquent)クラスをすべて格納します。
    各データベーステーブルに対応する「モデル」が存在し、データの照会や挿入に使います。
  </Accordion>
  <Accordion title="Providers/ ディレクトリ">
    アプリケーションのすべての[サービスプロバイダー](/jp/intermediate/service-providers)を格納します。
