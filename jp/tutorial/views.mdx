...
Laravelでは通常、[Bladeテンプレート言語](/jp/tutorial/blade)を使ってビューを記述します。
...
`.blade.php` 拡張子はフレームワークに、そのファイルが[Bladeテンプレート](/jp/tutorial/blade)を含むことを知らせます。
...
<Card title="Bladeテンプレート" icon="code" href="/jp/tutorial/blade">
