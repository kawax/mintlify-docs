...
クラウド実行は [Cloud Sessions](/jp/packages/laravel-copilot-sdk/cloud-sessions)、Plugin Directory は [Plugin Directories](/jp/packages/laravel-copilot-sdk/plugin-directories) を参照してください。
