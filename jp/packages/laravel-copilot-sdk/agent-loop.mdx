...
- [Streaming Events Reference](/jp/packages/laravel-copilot-sdk/streaming-events) — 各イベントタイプのフィールドレベル参照
- [Session Persistence](/jp/packages/laravel-copilot-sdk/resume) — セッション保存と再開
- [Hooks](/jp/packages/laravel-copilot-sdk/hooks) — ループ内イベントのインターセプト（権限・ツール）
