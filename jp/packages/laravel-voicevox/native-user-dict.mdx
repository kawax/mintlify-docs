---
title: "ネイティブモード - ユーザー辞書 - VOICEVOX for Laravel"
description: "VOICEVOX for Laravel のネイティブモードでユーザー辞書を使い、固有名詞や専門用語の読み方を登録・更新・インポートする方法を説明します。"
sidebarTitle: "ネイティブモード - ユーザー辞書"
---
