...
- 公式ドキュメント: [Starter Kits](https://laravel.com/docs/starter-kits)
...
[NewCommand.php](https://github.com/laravel/installer/blob/master/src/NewCommand.php) で確認したい箇所:

- [--using オプション定義](https://github.com/laravel/installer/blob/958a4e7c1386199a63d3c5e49a18b2e5c2ad1600/src/NewCommand.php#L119)
- [`create-project` と `post-root-package-install` の実行](https://github.com/laravel/installer/blob/958a4e7c1386199a63d3c5e49a18b2e5c2ad1600/src/NewCommand.php#L521-L569)
- [`getStarterKit()` の実装](https://github.com/laravel/installer/blob/958a4e7c1386199a63d3c5e49a18b2e5c2ad1600/src/NewCommand.php#L1237-L1255)
