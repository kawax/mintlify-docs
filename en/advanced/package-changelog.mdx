...
Always check the official [Laravel 13 upgrade guide](https://laravel.com/docs/13.x/upgrade). You can confirm current release status on [laravel/framework releases](https://github.com/laravel/framework/releases). If your package depends on APIs with breaking changes, you need to redesign compatibility policy before release.
