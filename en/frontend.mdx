...
flowchart TD
    ...
    G --> G1["Build CSS / JavaScript assets"]
```
...
Laravel 13's [starter kits](/en/starter-kits) include a **Livewire** option for teams that want to stay primarily in PHP. You get authentication, layout scaffolding, and Vite integration out of the box.
