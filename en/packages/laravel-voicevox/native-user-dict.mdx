---
title: "Native mode - User Dictionary - VOICEVOX for Laravel"
description: "Register, update, and import custom readings in native mode with the VOICEVOX for Laravel user dictionary."
sidebarTitle: "Native mode - User Dictionary"
---
