...
[Feed Generator](/en/packages/laravel-bluesky/feed-generator) covers building a custom feed generator with Laravel in detail.

### OAuth authentication

[Socialite](/en/packages/laravel-bluesky/socialite) explains how to implement OAuth authentication using Laravel Socialite. This is simpler than the official approach.
