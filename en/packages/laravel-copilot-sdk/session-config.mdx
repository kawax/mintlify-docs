...
For cloud execution, see [Cloud Sessions](/en/packages/laravel-copilot-sdk/cloud-sessions); for plugin directories, see [Plugin Directories](/en/packages/laravel-copilot-sdk/plugin-directories).
