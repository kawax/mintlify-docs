...
graph TD
    ...
    D["Boost<br>AI Development Tool"] --> A
...
sequenceDiagram
    ...
    Boost->>Boost: select guidelines per package
...
These packages are primarily aimed at **package developers and tool authors** rather than end users. However, they are already being used internally by official Laravel tools like Boost, and broader adoption across the ecosystem is expected as they mature toward v1.0.0.
