...
<Tip>
  Concurrent requests are ideal for dashboards that aggregate data from multiple endpoints. See the [Concurrency](/en/intermediate/concurrency) guide for running other types of concurrent tasks beyond HTTP requests.
</Tip>
