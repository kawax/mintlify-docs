...
<Info>
  As of Inertia 2.3, Precognition support is built in. This works in Inertia 3 as well. When you use Inertia forms, you usually do not need to add `laravel-precognition-vue` or `laravel-precognition-react`.
</Info>
...
The diagram below shows the difference between a normal submit flow and a precognitive validation flow.
...
sequenceDiagram
    ...
    Frontend->>Server: Precognition request<br>(Precognition: true header)
